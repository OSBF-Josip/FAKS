...
std::vector<VirtualPet> Owner::get_ljubimci()
{
	return this->ljubimci;
}
int get_counter(Food& hrana) { return hrana.counter; }
bool VirtualPet::operator==(const VirtualPet &drugi)
{
	return((this->ime == drugi.ime) && (this->vrsta == drugi.vrsta) && (this->glad == drugi.glad) && (this->sreca == drugi.sreca) && (this->budnost == drugi.budnost));
}
bool VirtualPet::operator!=(const VirtualPet& drugi)
{
	return((this->ime != drugi.ime) || (this->vrsta != drugi.vrsta) || (this->glad != drugi.glad) || (this->sreca != drugi.sreca) || (this->budnost != drugi.budnost));
...
Owner Owner::operator=(const Owner& drugi)
{
	return *this;
}
bool VirtualPet::operator<(const VirtualPet& drugi)
{
	return this->sreca < drugi.sreca;
}
bool VirtualPet::operator>(const VirtualPet& drugi)
{
	return this->sreca > drugi.sreca;
...
std::ostream& operator<<(std::ostream& os, const VirtualPet& vp)
{
	os << "Ime peta: " << vp.ime;
	return os;
}